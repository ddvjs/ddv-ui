...
Transition$1.prototype.beforeEnter = function beforeEnter (el) {
...
Transition$1.prototype.enter = function enter (el) {
...
Transition$1.prototype.afterEnter = function afterEnter (el) {
...
Transition$1.prototype.beforeLeave = function beforeLeave (el) {
  if (!el.dataset) { el.dataset = {}; }
  el.dataset.oldPaddingTop = el.style.paddingTop;
  el.dataset.oldPaddingBottom = el.style.paddingBottom;
  el.dataset.oldOverflow = el.style.overflow;
...
Transition$1.prototype.leave = function leave (el) {
  if (el.scrollHeight !== 0) {
...
Transition$1.prototype.afterLeave = function afterLeave (el) {
  removeClass$1(el, 'collapse-transition');
  el.style.height = '';
  el.style.overflow = el.dataset.oldOverflow;
  el.style.paddingTop = el.dataset.oldPaddingTop;
...
var script$6 = {
  ...
  methods: {
    handleWrapClose: function handleWrapClose () {
...
var __vue_render__$6 = function() {
  ...
  return _c(
    "transition",
    { attrs: { name: "dialog-fade" }, on: { "after-leave": _vm.afterLeave } },
    [
      _c(
        "div",
        {
          ...
          staticClass: "ddv-dialog__wrap",
          on: {
            click: function($event) {
              if ($event.target !== $event.currentTarget) {
                return null
              }
              return _vm.handleWrapClose($event)
            }
          }
        },
        [
          _c("div", { staticClass: "ddv-dialog", style: _vm.style }, [
            _c(
              "div",
              {
                staticClass: "ddv-dialog__header",
                class: {
                  "has-close": _vm.showClose
                }
              },
              [
                _vm._t("title", [
                  _c("span", { staticClass: "ddv-dialog__title" }, [
                    _vm._v(
                      "\n            " + _vm._s(_vm.title) + "\n          "
                    )
                  ])
                ...
                _vm.showClose
                  ? _c("i", {
                      staticClass: "ddv-dialog__icon iconfont icon-cuo",
            ...
            _vm.$slots.footer
              ? _c(
                  "div",
                  { staticClass: "ddv-dialog__footer" },
                  [_vm._t("footer")],
                  2
                )
              : _vm._e()
...
__vue_render__$8._withStripped = true;
  ...
  function __vue_normalize__$8(
    ...
    // For security concerns, we use only base name in production mode.
    component.__file = "/Users/sicmouse/Documents/github-project/ddv-ui/packages/inputNumber/src/inputNumber.vue";
  ...
  var InputNumber = __vue_normalize__$8(
